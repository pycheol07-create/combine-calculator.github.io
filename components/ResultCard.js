...
import {
    PriceIcon, ShippingIcon, TaxIcon, FeeIcon, TariffIcon,
    VatIcon, DocsFeeIcon, CoFeeIcon, ChevronDownIcon,
    PriceTagIcon, ReceiptIcon
} from './Icons.js';
...
export const ResultCard = ({ results }) => {
    ...
    // 아이콘 객체를 Icons.js에서 import한 컴포넌트들로 구성합니다.
    const Icons = {
        Price: <PriceIcon />,
