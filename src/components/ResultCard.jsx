...
// 분리된 아이콘 컴포넌트들을 모두 import 합니다.
import {
    PriceIcon, ShippingIcon, TaxIcon, FeeIcon, TariffIcon, VatIcon,
    DocsFeeIcon, CoFeeIcon, ChevronDownIcon, PriceTagIcon, ReceiptIcon
} from './Icons';
